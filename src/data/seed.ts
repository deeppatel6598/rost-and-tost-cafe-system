...
export const SEED_ITEMS: MenuItem[] = [
  ...
  item({ id: "lp-farmhouse", stallId: "la-pinos", categoryId: "lp-pizzas", name: "Farmhouse", description: "Onion, capsicum, corn, tomato and mushroom.", basePrice: 199, foodType: "veg", art: "pizza", sortOrder: 1 }),
  item({ id: "lp-paneer-tikka", stallId: "la-pinos", categoryId: "lp-pizzas", name: "Paneer Tikka Pizza", description: "Tandoori paneer, onion and capsicum.", basePrice: 219, foodType: "veg", art: "pizza", sortOrder: 2 }),
  item({ id: "lp-chicken-tikka", stallId: "la-pinos", categoryId: "lp-pizzas", name: "Chicken Tikka Pizza", description: "Tandoori chicken, onion and mint mayo drizzle.", basePrice: 249, foodType: "non_veg", art: "pizza", sortOrder: 3 }),
